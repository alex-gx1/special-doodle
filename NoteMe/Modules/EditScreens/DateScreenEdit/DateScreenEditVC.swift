...
protocol DateScreenEditViewModelProtocol {
    func closeVC()
...
final class DateScreenEditVC: UIViewController {
    ...
    private let viewModel: DateScreenEditViewModelProtocol
    ...
    private lazy var topLabel: UILabel = {
        ...
        label.text = "Редактирование задачи с датой"
        return label
    }()
    ...
    init(viewModel: DateScreenEditViewModelProtocol) {
